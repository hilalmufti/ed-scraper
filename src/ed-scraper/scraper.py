...
button.click()
# ed scraping
student_code = WebDriverWait(driver, TIME_OUT * 1000 ).until(lambda x: x.find_elements(By.XPATH, "/html/body/div[1]/div[1]/div/div/div/main/div/div/div/div/div[1]/div/div/div/div/div[3]/div/div/div/div[3]/div/div[4]/div/div[2]/div/div/div[1]/div/div/table"))
print(student_code)

student_feedback = WebDriverWait(driver, TIME_OUT * 1000).until(lambda x: x.find_elements(By.CLASS_NAME, "amber-el amber-paragraph amber-content"))
